from metodos.potencias_inversas import metodo_potencia_inversas
...
def matrix_2(n):
	...
	return A
def main():
	A = np.array([[6, 3, 4],[4,9,-3],[1,-1,3]])
	print(A)
	vector_x0 = np.random.rand(3,1)
	print(metodo_potencia_inversas(vector_x0, A).sassenfeld_criteria())
	# while True:
	# 	try:
